...
The public email and GitHub fields are intentionally empty because they were not present in the verified LinkedIn/Apify source. Certifications, recommendations, skills, courses, projects, profile image, and website link are stored in `src/data/profile.ts` and can be edited there.
